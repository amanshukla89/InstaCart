...
//get user addresses
//GET/api/addresses
export const getAddreses = async (req: Request, res: Response) => {
...
export const addAddress = async (req: Request, res: Response) => {
    ...
    if (lat == null || lng == null) {
        return res.status(400).json({ message: "Location coordinates are required.Please allow location acces." });
    }
