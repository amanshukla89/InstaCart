        ...
        <div className="min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <button onClick={() => navigate(-1)}
                    ...
                    text-sm text-app-text-light hover:text-app-green transition-colors">
                    ...
                    <div className="grid md:grid-cols-2 gap-0">
                        ...
                        <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
                            ...
                            <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                                {product.isOrganic && (
                                    <span className="flex items-center gap-1 px-2.5 py-1 text-xs font-semibold bg-app-green
                                text-white">
                        ...
                        <div className="p-6 md:p-10 flex flex-col justify-center">
                            ...
                            {product.rating > 0 && (
                                <div className="flex items-center gap-2 mb-5">
                                    <div className="flex items-center gap-0.5">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <StarIcon key={star} className=
                                                {`w-4 h-4 ${star <= Math.round(product.rating) ?
                            ...
                            <div className="mb-6">
                                {product.stock > 0 ? (
                                    ...
                                    <span className="text-sm text-app-error font-semibold">Out of Stock</span>
                                )}
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex items-center border border-app-border rounded-xl overflow-hidden">
                                    <button onClick={handleMinus}
                                        className="p-3 hover:bg-app-cream tansition-colors">
                                ...
                                <button onClick={() => {
                                    ...
                                    rounded-xl transition-colors flex-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed active:scale-
                                    [0.98] ${inCart ? "bg-app-cream text-app-green border border-app-green" :
                ...
                {relatedProducts.length > 0 && (
                    <section className="mt-12 mb-44">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <Link className="text-sm font-semibold text-app-orange hover:text-app-orange-dark flex items-center
