...
const Checkout = () => {
    ...
    const delievryFee = cartTotal > 20 ? 0 : 1.99;
    const tax = cartTotal * 0.08;
    const total = cartTotal + delievryFee + tax;

    const steps: { key: string; label: string; icon: typeof MapPinIcon }[] = [
        { key: "address", label: "Address", icon: MapPinIcon },
        { key: "payment", label: "Payement", icon: CreditCardIcon },
            ...
            <div className="min-h-screen bg-app-cream flex-center">
                <div className="text-center">
                    ...
                    <button onClick={() => navigate("/products")} className="
                                 px-5 py-2.5 bg-app-green text-white text-sm font-medium rounded-xl 
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-2">
                        {step === "address" && <CheckoutAddress address={address} setAddress={setAddress} setStep={setStep}
                            user={user} />}
                    ...
                    <div className="bg-white rounded-2xl p-5 h-fit sticky top-24">
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span>
                                    {delievryFee === 0 ? <span className="text-app-success">Free</span> : `${currency}
                                    ${delievryFee.toFixed(2)}`}
                                </span>
                            </div>
