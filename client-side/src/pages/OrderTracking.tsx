            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <span className={`px-4 py-1.5 text-sm font-semibold rounded-full ${order!.status === "Delivered" ?
                        "bg-green-100 text-green-700" : order!.status === "Cancelled" ? "bg-red-100 text-red-700" :
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="bg-white rounded-2xl p-5">
                            ...
                            <div className="mt-4 pt-3 border-t border-app-border space-y-1.5 text-sm">
                                ...
                                <div className="flex justify-between pt-2 border-t  border-app-border font-semibold
                                text-app-green">
                                    <span >
                                        Total
                                    </span>
