            ...
            h-16 gap-4">
                ...
                <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
                    ...
                    <div className="flex items-center gap-3">
                        {/* Cart */}
                        <button className="relative p-2 rounded-x1" onClick={() =>
                            setIsCartOpen(true)}>
                        ...
                        <div className="relative">
                            {user ? (
                                <button onClick={() => setUserMenuOpen(!userMenuOpen)} className="flex 
                                ...
                                <>
                                    ...
                                    border-app-border py-2 z-50 animate-fade-in">
                                        ...
                                        <div onClick={() =>
                                            setUserMenuOpen(false)}>
                                            {!user && <Link to='/login'
                                                className="dropdown-link"> <UserIcon size={16} /> Sign In
                                            </Link>}
                                            {user && <Link to='/orders'
                                                className="dropdown-link"> <PackageIcon size={16} />
                                                My Orders
                                            </Link>}
                                            {user && <Link to='/addresses'
                                                className="dropdown-link"> <MapPinIcon size={16} />
                                                Addresses
                                            </Link>}
                                            <Link to='/products'
                                                className="dropdown-link md:hidden"> <ArrowUpRightIcon size={16} />
                                                Products
                                            </Link>
