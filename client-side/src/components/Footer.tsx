                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            {footerData.brand.socials.map((social, i) => (
                                <a key={i} className="size-9 rounded-lg bg-white/10 flex-center
                            hover:bg-white/10 flex-center hover:bg-white/2"><social.icon
                                        className="size-4" /></a>
                            ))}
                        </div>
                    </div>
                        ...
                        <div key={i}>
                            ...
                            <ul className="space-y-2.5">
                                {section.links.map((link, i) => (
                                    <li key={i}>
                                        {link.to ? (
                                            <Link to={link.to} className="text-sm text-white/70
                                            hover:text-white">
                                                {link.label}
                                            </Link>
                                        ) : (
                                            <a href={link.href} className="text-sm
                                            text-white/70 hover:text-white">{link.label}</a>
